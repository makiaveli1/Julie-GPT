...
class Juliebot:
    ...
    def send_message(self, task, user_name):
        try:
            ...
            self.long_term_memory.update_conversation_history(user_name, "user", task)
        ...
        try:
            ...
            for message in sorted_messages:
                if message.role == "assistant":
                    ...
                    self.long_term_memory.update_conversation_history(user_name, "assistant", text_content)
